...
async def async_setup_entry(
    ...
    add: list[BinarySensorEntity] = [
        ...
        _Bool(coordinator, entry, "Filter 1 Installed", "filter_1_present",
              lambda d: bool(d.filter_tag1), None, "mdi:air-filter"),
        _Bool(coordinator, entry, "Filter 2 Installed", "filter_2_present",
              lambda d: bool(d.filter_tag2), None, "mdi:air-filter"),
